#!/usr/bin/env python3
"""Apply plan-driven residual vocal EQ after the selected template chain."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Apply residual EQ actions stored in a resolved mix plan.")
